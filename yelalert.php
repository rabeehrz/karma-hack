...
if(!empty($_GET['latitude']) && !empty($_GET['longitude']) && !empty($_GET['note'])) {
    ...
    $sql = "INSERT INTO `location` (latitude,longitude,alert,code,note) VALUES ('".$latitude."','".$longitude."',1,'" . $time . "','" . $note . "')";
...
<head>
   ...
   crossorigin=""></script>
    <title>Yellow Alert&bull; KARMA</title>
</head>
<body>
    <div class="wrapper">
        ...
        <h4 class="heading"><font color="yellow">Yellow Alert!</font></h4>
            <div id="mapid"></div><br>
            <form>
    ...
    $(document).ready(function(){
        $("#submit").click(function() {
            var note = document.getElementById('note').value
                    ...
                    document.location.href = 'yelalert.php?latitude='+lat+'&longitude='+lng+'&note='+note;
        });
    });
