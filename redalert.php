...
if(!empty($_GET['latitude']) && !empty($_GET['longitude']) && !empty($_GET['note'])) {
    ...
    $sql = "INSERT INTO `location` (latitude,longitude,alert,code,note) VALUES ('".$latitude."','".$longitude."',3,'" . $time . "','" . $note . "')";
...
<head>
   ...
   crossorigin=""></script>
    <title>Red Alert &bull; KARMA</title>
</head>
<body>
    ...
    <div class="wrapper">
        ...
        <h4 class="heading"><font color="red">Red Alert!</font></h4>
            <div id="mapid"></div><br>
            <form>
        ...
        function onLocationFound(e) {
            ...
            $(document).ready(function(){
                $("#submit").click(function() {
                    ...
                    document.location.href = 'redalert.php?latitude='+e.latlng.lat+'&longitude='+e.latlng.lng+'&note='+note;
                });
            });
        }
